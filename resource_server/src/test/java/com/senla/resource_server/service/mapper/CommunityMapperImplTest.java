...
class CommunityMapperImplTest {
    ...
    @Test
    void toSendCommunityMessageResponseDto_shouldReturnNull_whenInputIsNull() {
        // given
        PublicMessage message = null;

        // when
        SendCommunityMessageResponseDto dto = mapper.toSendCommunityMessageResponseDto(message);
    ...
    @Test
    void toSendCommunityMessageResponseDto_shouldMapCorrectly_whenMessageAndCommunityAreNotNull() {
        // given
        Community community = Community.builder().name("Dev").build();
        ...
        // then
        assertThat(dto).isNotNull();
        assertThat(dto.getCommunityName()).isEqualTo("Dev");
        assertThat(dto.getContent()).isEqualTo("Hello world");
    }

    @Test
    void toSendCommunityMessageResponseDto_shouldMapCommunityNameAsNull_whenCommunityIsNull() {
        // given
        PublicMessage message = PublicMessage.builder()
                .content("Msg without community")
                .community(null)
                .build();
        ...
        // then
        assertThat(dto).isNotNull();
        assertThat(dto.getCommunityName()).isNull();
        assertThat(dto.getContent()).isEqualTo("Msg without community");
    }
