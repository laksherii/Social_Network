...
public class FriendRequestMapperImplTest {
    ...
    private FriendRequestMapperImpl mapper;

    @BeforeEach
    void setUp() {
        mapper = new FriendRequestMapperImpl();
    }
    ...
    void toSendFriendResponseDto_shouldReturnNull_whenInputIsNull() {
        ...
        // when
        SendFriendResponseDto result = mapper.toSendFriendResponseDto(request);
    ...
    void toAnswerFriendResponseDto_shouldReturnNull_whenInputIsNull() {
        ...
        // when
        AnswerFriendResponseDto result = mapper.toAnswerFriendResponseDto(request);
